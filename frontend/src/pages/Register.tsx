...
export const Register: React.FC = () => {
    ...
    return (
        <div className="flex items-center justify-center min-h-screen py-12 bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">
                        ...
                        <div className="pt-2">
                            <label className="flex items-start space-x-2 cursor-pointer">
                                <input
                                    ...
                                    onChange={handleChange}
                                    className="w-4 h-4 mt-1 text-blue-600 rounded border-slate-300 focus:ring-2 focus:ring-blue-500"
                                />
