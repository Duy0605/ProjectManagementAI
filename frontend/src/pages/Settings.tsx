                        ...
                        <div className="space-y-3">
                            {[
                                ...
                                },
                                {
                                    ...
                                    desc: "Important project announcements",
                                },
                                {
                                    key: "weeklyReports",
                                ...
                                <div
                                    key={item.key}
                                    className="flex items-center justify-between p-4 border rounded-lg border-slate-200"
                                >
                                    <div>
                                        <p className="font-medium text-slate-800">
                                            {item.label}
                ...
                <div className="space-y-4">
                    {[
                        ...
                        },
                        {
                            ...
                            desc: "Sync deadlines with your calendar",
                            connected: false,
                            icon: "📅",
                        },
                        {
                            name: "Jira",
                            desc: "Import issues from Jira projects",
                            connected: false,
                            icon: "🔷",
                        },
                        {
                            name: "Figma",
                            desc: "Attach design files to tasks",
                            connected: false,
                            icon: "🎨",
                        },
                        {
                            name: "Zoom",
                            desc: "Create meeting links for tasks",
                            connected: true,
                            icon: "📹",
                        },
                    ].map((integration) => (
                ...
                <div className="space-y-6">
                    ...
                    <div className="p-4 border rounded-lg border-amber-200 bg-amber-50">
                        ...
                        <p className="mb-4 text-sm text-amber-700">
                            Your data is automatically backed up and retained
